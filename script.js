...
const wordle = targetWords[Math.floor(dayOffset)].toUpperCase();
console.log(wordle);
...
const flipTile = () => {
  ...
  rowTiles.forEach(rowTile => {
    guess.push({
      letter: rowTile.getAttribute('data'),
      color: 'grey-overlay'
    });
  });
...
// rowTiles.forEach((rowTile, index) => {
//   const dataLetter = rowTile.getAttribute('data');

//   setTimeout(() => {
//     rowTile.classList.add('flip');
//     if (dataLetter == wordle[index]) {
//       rowTile.classList.add('green-overlay');
//       addColorToKey(dataLetter, 'green-overlay');
//     } else if (wordle.includes(dataLetter)) {
//       rowTile.classList.add('yellow-overlay');
//       addColorToKey(dataLetter, 'yellow-overlay');
//     } else {
//       rowTile.classList.add('grey-overlay');
